...
export default function PricingPage() {
  ...
  return (
    /* overflow-y-auto is critical — body has overflow:hidden in globals.css */
    <main className="min-h-screen overflow-y-auto bg-zinc-950 text-zinc-100">

      {/* ── Sticky header ── */}
      <header className="sticky top-0 z-30 glass-bright border-b border-white/5 px-4 h-14 flex items-center gap-3">
        <Link
          href="/"
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <section className="pt-20 pb-16 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-16 text-left">
            {[
              ...
              <div
                key={title}
                className={cn("glass-sm rounded-2xl p-5 border", bg)}
              >
            ...
            */}
            <div className="glass rounded-2xl p-5 flex flex-col gap-3 relative overflow-hidden">
              ...
              <div className="flex-1 flex items-center justify-center py-4 relative">
                {/* Conic-gradient gauge ring */}
                <div
                  className="size-32 rounded-full flex items-center justify-center relative"
                  style={{
                    background:
                      "conic-gradient(#22c55e 0% 72%, rgba(255,255,255,0.04) 72% 100%)",
                  }}
                >
                  ...
                  <div key={r.period} className="flex items-center gap-2">
                    ...
                    <span
                      className={cn(
                        ...
                        r.positive ? "text-emerald-400" : "text-red-400"
                      )}
                    >
                      {r.ret}
                    </span>
            ...
            */}
            <div className="glass rounded-2xl p-5 flex flex-col gap-3 relative overflow-hidden">
              ...
              <div className="flex gap-1.5 flex-wrap">
                <span className="px-2 py-0.5 rounded-full bg-violet-500/20 border border-violet-500/30 text-violet-300 text-[10px] font-medium">
                  RSI
                </span>
        ...
        <section className="pb-24">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
            ...
            {/* ── FREE ── */}
            <div
              className="glass rounded-2xl p-6 flex flex-col gap-4 animate-fade-up"
            ...
            >
              ...
              <div>
                <div className="flex items-end gap-1.5">
                  <span className="text-5xl font-black text-zinc-100 font-mono leading-none">
                    ${basicPrice}
                  </span>
                  <span className="text-zinc-500 text-sm mb-1">/mo</span>
                </div>
